...
class Note extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      Note: [],
      Remember: [
        "සමචතුරස්රයක පරිමිතිය = පැත්තක දිග x 4",
        "සමචතුරස්රයක පරිමිතිය = පැත්තක දිග x 5",
        "සමචතුරස්රයක පරිමිතිය = පැත්තක දිග x 6",
        "සමචතුරස්රයක පරිමිතිය = පැත්තක දිග x 7",
        "සමචතුරස්රයක පරිමිතිය = පැත්තක දිග x 8",
        "සමචතුරස්රයක පරිමිතිය = පැත්තක දිග x 9",
        "සමචතුරස්රයක පරිමිතිය = පැත්තක දිග x 10",
      ],
  ...
  getContentAndDefaultNote = (id) => {
    fetch(Url + "/v1/tutor/topics?lessonId=" + id)
      .then((res) => res.json())
      .then((Response) =>
        this.setState({
  ...
  getNoteHandler = (SubId, Id) => {
    ...
    fetch(Url + "/v1/tutor/smartnote/" + lesId + "/" + Id + "/" + SubId)
      .then((res) => res.json())
      .then((response) => {
        this.setState({
          Note: response,
      ...
      <Layout>
        <div className="container-fluid">
          <div className="Note_Sec">
            ...
            <div className="row">
              <div className="col-3">
                ...
                <div className="rememberSec">
                  ...
                  {this.state.Remember.map((rem) => (
                    <h4 className="remLi">{rem}</h4>
                  ))}
                </div>
              </div>
              <div className="col-7">
                ...
                <div className="refVidSec">
                  ...
                  {this.state.referanceVideo.map((vid) => (
                    <a
                      href="#/"
                      onClick={() => {
                        this.setState({ VidId: vid, show: true });
                      }}
                    >
                      <img
            ...
            <a href={"/Examing/" + this.props.match.params.id} id="quationBtn">
              Go Practice
            </a>
          </div>
        </div>
